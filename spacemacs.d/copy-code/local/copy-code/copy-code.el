...
;; Uses the tool "pygmentize", and the system utility "pbcopy" to copy the
...
(defun copy-code-as-rtf (&optional font-size)
  ...
  (let* ((real-font-size
          (if (and font-size
            ...
            48))
         (common-options
          (format "-O \"fontface=Source Code Pro,fontsize=%d,style=native\""
                  real-font-size
                  ))
